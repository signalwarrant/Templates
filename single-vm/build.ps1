...
$resourceGroupName = "singleVMRG"
$templateFilePath = '.\singleVM-deploy.json'
...
# Template Deployment
$templateParamFile = @("\singleVM-param.json") # these are the parameter files
New-AzResourceGroupDeployment -ResourceGroupName $resourceGroupName -Name DefenderSecLab -TemplateFile $templateFilePath -TemplateParameterFile $templateParamFile